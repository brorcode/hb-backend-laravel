...
class DashboardDebitByMonthTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testCanSeeDebitAmountGroupedByMonth(): void
    {
        $now = Carbon::now();
        ...
        $response = $this->postJson(route('api.v1.dashboard.debit-by-month'));
    ...
    public function testItReturnsNoDataWhenNoDebitTransactionsForSelectedPeriod(): void
    {
        ...
        $response = $this->postJson(route('api.v1.dashboard.debit-by-month'), ['months' => 1]);
    ...
    public function testItReturnsFilteredDebitDataForSelectedPeriod(): void
    {
        ...
        $response = $this->postJson(route('api.v1.dashboard.debit-by-month'), ['months' => 3]);
